...
-- Step 1: Create Principal and demo data
DO $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE 'Successfully created: 1 principal (%), 5 teachers, 1 school (%), 3 classes, and 9 subjects', principal_profile_id, school_id;
END $$;