-- First, clean up all existing demo data
DELETE FROM public.profiles WHERE user_id IN (
    SELECT id FROM auth.users WHERE email LIKE '%@school.edu' OR email LIKE '%@riverside.edu'
);

DELETE FROM auth.users WHERE email LIKE '%@school.edu' OR email LIKE '%@riverside.edu';
