-- Complete fresh start: Remove all existing data and create new demo data
DO $$
DECLARE
    principal_id UUID;
    teacher1_id UUID;
...
BEGIN
    ...
    DELETE FROM public.video_materials;
    DELETE FROM public.subject_enrollment_requests;
