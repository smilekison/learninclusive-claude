-- Clean slate with correct UUID format
...
-- Create demo users with proper UUIDs and credentials
...
(
    '00000000-0000-0000-0000-000000000000'::uuid, 
    'd4e5f6a7-b8c9-0123-def4-567890123456'::uuid,
    'authenticated', 'authenticated',
...
('d4e5f6a7-b8c9-0123-def4-567890123456'::uuid, 'Alex', 'Martinez', 'student', NULL),
