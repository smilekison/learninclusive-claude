-- Seed demo data: 3 classes, 6 subjects, 10 students distributed across classes
-- This script is idempotent: it checks for existing emails and avoids duplicate enrollments
...
BEGIN
  -- Create classes if not already created in this session
