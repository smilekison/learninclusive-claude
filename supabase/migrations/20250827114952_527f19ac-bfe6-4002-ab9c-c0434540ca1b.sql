...
CREATE TABLE assignment_ai_suggestions (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE submission_collaboration (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  submission_id UUID NOT NULL,
...
CREATE TABLE assignment_accessibility (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  assignment_id UUID NOT NULL,
...
CREATE TABLE assignment_chunks (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  assignment_id UUID NOT NULL,
...
CREATE INDEX idx_assignment_templates_category ON assignment_templates(category);
CREATE INDEX idx_assignment_templates_public ON assignment_templates(is_public);
CREATE INDEX idx_assignment_ai_suggestions_assignment ON assignment_ai_suggestions(assignment_id);
CREATE INDEX idx_assignment_collaborators_assignment ON assignment_collaborators(assignment_id);
CREATE INDEX idx_submission_workflows_assignment ON submission_workflows(assignment_id);
CREATE INDEX idx_submission_versions_submission ON submission_versions(submission_id);
CREATE INDEX idx_originality_checks_submission ON originality_checks(submission_id);
CREATE INDEX idx_assignment_recommendations_student ON assignment_recommendations(student_id);
CREATE INDEX idx_assignment_accessibility_assignment ON assignment_accessibility(assignment_id);
CREATE INDEX idx_assignment_chunks_assignment ON assignment_chunks(assignment_id);
CREATE INDEX idx_assignment_schedules_student ON assignment_schedules(student_id);
CREATE INDEX idx_assignment_media_assignment ON assignment_media(assignment_id);
CREATE INDEX idx_assignment_competencies_assignment ON assignment_competencies(assignment_id);
CREATE INDEX idx_assignment_insights_assignment ON assignment_insights(assignment_id);
